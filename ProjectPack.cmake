...
if(NOT PackTarget STREQUAL "")
    ...
    string(REPLACE ";" "\" \"" OUTPUT_RESOURCES "\"${${PackTarget}StreamingAssets}\"")
    add_custom_target(Pack
        DEPENDS ${PackTarget}
        COMMAND cmake -E copy_directory "${OUTPUT_DIRECTORY}/${PackType}" "${PackPath}"
        COMMAND if \"${${PackTarget}StreamingAssets}\" NEQ \"\" cmake -E copy_directory ${OUTPUT_RESOURCES} "${PackPath}/StreamingAssets"
        COMMENT "打包成功"
    )
endif()