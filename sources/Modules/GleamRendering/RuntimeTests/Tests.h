...
Gleam_MakeInitEvent()
{
    ...
    Entity cameraEntity = World::AddSceneEntity(TestCameraArchetype);
    ...
    Entity pointsRendererEntity = World::AddSceneEntity(PointRendererArchetype);
    ...
    Entity linesRendererEntity = World::AddSceneEntity(LineRendererArchetype);
