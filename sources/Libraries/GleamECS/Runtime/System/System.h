...
namespace Gleam
{
    ...
    class System : public ISystem<TGroup, TMinOrder, TMaxOrder>
    {
    };
    template <class TParentSystem, int Order>
    class AbsoluteSystem : public ISystem<TParentSystem, Order, Order>
    {
    };
    ...
    class RelativeSystem : public ISystem<typename TBrotherSystem::Group,
