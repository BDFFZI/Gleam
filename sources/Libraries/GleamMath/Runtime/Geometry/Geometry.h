...
namespace Gleam
{
    ...
    {
    public:
        static bool Contains(const Rectangle& rectangle, float2 point);
        static bool Contains(const Cuboid& cuboid, float3 point);
        static bool Contains(const Sphere& sphere, float3 point);
