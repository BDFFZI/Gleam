...
Gleam_MakeVectorFunctions_Decimals(Type, (Row) * (Column))\
...
MakeMatrixFunction_Adjoint(Type,Row,Column)
    ...
    Gleam_MakeVectorFunction_All(bool, 3*3)
    Gleam_MakeVectorFunction_All(bool, 4*4)
    Gleam_MakeVectorFunction_Any(bool, 3*3)
    Gleam_MakeVectorFunction_Any(bool, 4*4)
