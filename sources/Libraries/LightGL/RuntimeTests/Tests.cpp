...
public:
    GLTester()
    {
        ...
        //创建顶点索引缓冲区
        RawMesh mesh = ModelImporter::ImportObj("Resources/LightGLRuntimeTests/viking_room.obj");
        ...
        //创建纹理及采样器
        RawImage rawImage = ImageImporter::Import("Resources/LightGLRuntimeTests/viking_room.png", STBI_rgb_alpha);
