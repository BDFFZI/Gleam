...
void GLStateLayout::SetViewportCount(const uint32_t viewportCount, const uint32_t scissorCount)
{
    viewport.viewportCount = viewportCount;
    viewport.scissorCount = scissorCount;
}
void GLStateLayout::SetViewport(const std::vector<VkViewport>* viewports, const std::vector<VkRect2D>* scissors)
{
...
void GLStateLayout::SetRasterizationSamples(const VkSampleCountFlagBits rasterizationSamples)
{
    multisample.rasterizationSamples = rasterizationSamples;
}
void GLStateLayout::SetLineWidth(const float lineWidth)
{
    rasterization.lineWidth = lineWidth;
}
void GLStateLayout::SetCull(const VkCullModeFlags cullMode)
{
    rasterization.cullMode = cullMode;
}
void GLStateLayout::SetOffset(const bool depthBiasEnable, const float depthBiasSlopeFactor, const float depthBiasConstantFactor)
{
...
void GLStateLayout::SetZClip(const bool depthClampEnable)
{
    rasterization.depthClampEnable = depthClampEnable;
}
void GLStateLayout::SetZTest(const VkCompareOp depthCompareOp)
{
    depthStencil.depthCompareOp = depthCompareOp;
}
void GLStateLayout::SetZWrite(const bool depthWriteEnable)
{
    depthStencil.depthWriteEnable = depthWriteEnable;
}
void GLStateLayout::SetBlend(const bool blendEnable, const VkBlendFactor srcColorBlendFactor, const VkBlendFactor dstColorBlendFactor)
{
...
void GLStateLayout::SetBlendOp(const VkBlendOp colorBlendOp)
{
    colorBlendAttachment.colorBlendOp = colorBlendOp;
}
void GLStateLayout::SetColorMask(const VkColorComponentFlags colorMask)
{
