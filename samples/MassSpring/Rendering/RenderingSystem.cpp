...
namespace Light
{
    ...
    void RenderingSystem::Start()
    {
        ...
        pointShader = std::make_unique<GShader>("Assets/VertexColor.hlsl", GraphicsConfig::DefaultStateLayout, pointMeshLayout);
        lineShader = std::make_unique<GShader>("Assets/VertexColor.hlsl", GraphicsConfig::DefaultStateLayout, lineMeshLayout);
